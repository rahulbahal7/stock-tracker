...
<table border="0" align="center" cellpadding="0" cellspacing="0" class="layout">
  <tr>
    <td align="left" valign="top"><table width="780" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="40" align="center" valign="middle" bgcolor="#E9EDD4"><pre class="menu"><a href="../YT-AC0103/html/index.html">Home</a>       |       <a href="../YT-AC0103/html/content.html">About us</a>       |       <a href="index.html">STOCK TRACKER</a>       |       <a href="../YT-AC0103/html/contact.html">Contact us</a></pre></td>
      </tr>
      <tr>
        <td align="left" valign="top"><table width="780" border="0" cellpadding="0" cellspacing="0" bgcolor="#F6FFDB">
          <tr>
            <td height="133" colspan="2" align="left" valign="top"><table width="594" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="265" height="133" align="left" valign="top"><a href="index.html"><img src="../YT-AC0103/html/images/index_03.gif" alt="" width="265" height="133" border="0" /></a></td>
...
<?php
	...
	*/
	...
	$SQL = "INSERT INTO tbl_user (firstname, lastname ,email , user_name , password) VALUES ('$_POST[firstname]','$_POST[lastname]','$_POST[email]','$username','$password')";
	$result = mysql_query($SQL) or die('Query failed: ' . mysql_error());
	mysql_close($db_handle);
	//echo 'Records added to the database';
	echo "<a href=secure.php>";
	echo '<br/>';
	echo ' CLICK HERE TO CONTINUE TO LOGIN';
	echo '</a>' ;
	}
	else if($numrows>0)
	{
